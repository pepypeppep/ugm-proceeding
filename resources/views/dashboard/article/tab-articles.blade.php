  ...
  <section class="body pb-5">
    <div class="row pt-4">
      ...
      <ul class="nav nav-pills nav-fill sticky-top sticky-nav bg-light d-md-none mb-2">
        <li class="nav-item">
          <a class="nav-link"><i class="fas fa-print m-0"></i></a>
        </li>
        <li class="nav-item">
          <a class="nav-link"><i class="far fa-file-pdf m-0"></i></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ route('article.edit', ['article' => $article->id]) }}"><i class="fas fa-edit m-0"></i></a>
        </li>
      </ul>
      <div class="col-md-10">
        <div class="mb-2">
