...
<section class="header py-5">
  <div class="row justify-content-between">
    <div class="col-md-6 mb-3 mb-md-0">
      ...
      <a href="{{ route('article.show', [$articles->id]) }}" class="text-primary" style="font-size: 0.9rem"><i class="fas fa-angle-left fa-fw"></i>Back to article</a>
    </div>
  </div>
</section>
@endsection
          ...
          <div class="card">
            <div class="card-body" id="cardBody">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control @if($errors->has('title')) is-invalid @endif" name="title" id="title" rows="1">{{ $articles->data['title'] }}</textarea>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-5">
                  <input name="start_page" type="number" class="form-control mb-2 mb-sm-0 @if($errors->has('start_page')) is-invalid @endif" id="start_page" placeholder="Start page" value="{{ $articles->data['start_page'] }}" required>
                  <div class="invalid-feedback">{{ $errors->first('start_page') }}</div>
                </div>
                <div class="col-sm-5">
                  <input name="end_page" type="number" class="form-control mb-2 mb-sm-0 @if($errors->has('end_page')) is-invalid @endif" id="end_page" placeholder="End page" value="{{ $articles->data['end_page'] }}" required>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea id="summernote" class="form-control @if($errors->has('abstract')) is-invalid @endif" name="abstract" id="abstract" rows="5">{{ $articles->data['abstract'] }}</textarea>
              ...
              <div class="form-group row" id="keywords">
                ...
                <div class="col-md-8 col-12">
                  <input type="text" name="keywords" class="form-control @if($errors->has('keywords')) is-invalid @endif" value="{{ $articles->keywords }}">
